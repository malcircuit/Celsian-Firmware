...
#define SPI1_CONFIG_SCK_PIN         17
#define SPI1_CONFIG_MOSI_PIN        19
#define SPI1_CONFIG_MISO_PIN        9
...
#define UART0_CONFIG_PSEL_TXD     18
#define UART0_CONFIG_PSEL_RXD     21
